...
ToolButton {
    ...
    // Używaj contentItem zamiast anchors.fill: parent
...
IconImage {
    width: 20
    height: 20
    source: Qt.resolvedUrl("../../media/cpu.svg")
    onStatusChanged: {
        if (status === Image.Error) {
            console.log("Nie mogę załadować ikony:", source)
        }
    }
}


        // jeśli chcesz z powrotem tekst, odkomentuj
        // Label {
        //     text: " " + cpu + "%" + " | " + temp + "°C"
